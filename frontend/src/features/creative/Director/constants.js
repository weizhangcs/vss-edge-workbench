// frontend/src/features/creative/Director/constants.js
...
export const SCHEMA = {
    narration: {
        narrative_focus: {
            label: "叙事焦点", group: "content", widget: "segmented",
            type: TYPES.VALUE,
            options: [
    ...
    localize: {
        target_lang: {
            label: "目标语言", group: "content", widget: "segmented",
            type: TYPES.VALUE,
            options: [
                { label: "英语", value: "en" },
                { label: "中文", value: "zh" },
    ...
    audio: {
        ...
        voice_name: {
            label: "音色选择", group: "content", widget: "segmented",
            type: TYPES.VALUE,
            options: [
...
export const DEFAULTS = {
    narration: {
        ...
        perspective_character: { type: TYPES.VALUE, value: '' },
